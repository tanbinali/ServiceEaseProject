...
class CategoryViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        operation_description="Retrieve a list of all service categories. Publicly accessible.",
    ...
    @swagger_auto_schema(
        ...
        operation_description=(
            ...
            "If no active services exist, returns an empty list."
        ),
    ...
    def services(self, request, pk=None):
        ...
        # Get only active services that were prefetched
